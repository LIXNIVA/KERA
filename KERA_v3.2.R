...
ui <- navbarPage(
  title  = tags$span(
    "KERA",
    tags$span(
      style = "font-size:11px; font-weight:400; letter-spacing:1px; color:rgba(255,255,255,0.6); margin-left:18px; font-family:'Segoe UI',sans-serif;",
      "📧 Contact: ",
      tags$a("Li Xie — li.xie@niva.no",
             href   = "mailto:li.xie@niva.no",
